...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{fig/脉冲图.png}
...
最终得到的计算结果如图\ref{fg:Hecr}所示，
位移误差收敛率和能量误差收敛率并没有达到理论误差收敛率，
其原因是，该算例的精确解的连续性不够，存在梯度变化很大的区域，
所以导致误差收敛时出现了收敛性不足的问题。
...
针对完全弱形式伽辽金法在时间末端本质边界条件难以直接施加的难点，
